...
})(
    {
        1: [
            function (a, b, c) {
                ...
                function f() {
                    function a(a) {
                        v.visible !== !1 && (f[h](), (C.position.z = 0.1 * u), (a.locked = !0));
                    }
                    function b() {
                        C.position.z = 0.5 * u;
                    }
                    ...
                    A.modify(z), z.translate(0.5 * s, 0, 0);
                    var B = new THREE.MeshBasicMaterial();
                    B.visible = !1;
                    var C = new THREE.Mesh(z.clone(), B);
                    (C.position.z = 0.5 * u), (C.position.x = 0.5 * k);
                    var D = new THREE.MeshBasicMaterial({ color: l.BUTTON_COLOR }),
                        E = new THREE.Mesh(z.clone(), D);
                    C.add(E);
                    var F = e.create(h, { scale: 0.866 });
                    (F.position.x = 0.5 * s - 11e-6 * F.layout.width * 0.5), (F.position.z = 1.2 * u), (F.position.y = -0.025), E.add(F);
                    var G = e.create(h);
                    (G.position.x = n.PANEL_LABEL_TEXT_MARGIN), (G.position.z = r), (G.position.y = -0.03);
                    ...
                    var J = q.create({ group: v, panel: w });
                    return (
                        (v.updateControl = function (a) {
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.default = f);
            ...
            { "../thirdparty/SubdivisionModifier": 17, "./colors": 3, "./grab": 7, "./interaction": 10, "./layout": 11, "./sharedmaterials": 14, "./textlabel": 16 },
        ],
        2: [
            function (a, b, c) {
                "use strict";
                ...
                function f() {
                    ...
                    A.translate(0.5 * u, 0, 0);
                    var B = new THREE.MeshBasicMaterial();
                    B.visible = !1;
                    var C = new THREE.Mesh(A.clone(), B);
                    (C.position.z = t), (C.position.x = 0.5 * n);
                    var D = new THREE.MeshBasicMaterial({ color: k.CHECKBOX_BG_COLOR }),
                        E = new THREE.Mesh(A.clone(), D);
                    C.add(E);
                    var F = d.create(g);
                    (F.position.x = m.PANEL_LABEL_TEXT_MARGIN), (F.position.z = t), (F.position.y = -0.03);
                    ...
                    H.material.color.setHex(2063079), (H.position.x = 0.5 * -m.BORDER_THICKNESS + 0.5 * n), (H.position.z = 0.5 * t);
                    var I = o.checkmark();
                    (I.position.z = 0.51 * t), C.add(I), z.add(F, C, G, H);
                    var J = (0, i.default)(C);
                    ...
                    (y.onChange = function (a) {
                        ...
                        (y.interaction = J),
                        (y.hitscan = [C, z]);
                    var L = r.create({ group: y, panel: z });
                    return (
                        (y.listen = function () {
                            return (x.listen = !0), y;
                        }),
            ...
            { "./colors": 3, "./grab": 7, "./graphic": 8, "./interaction": 10, "./layout": 11, "./sharedmaterials": 14, "./textlabel": 16 },
        ],
        3: [
            function (a, b, c) {
                "use strict";
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.colorizeGeometry = d);
                (c.DEFAULT_COLOR = 3121622),
                    (c.HIGHLIGHT_COLOR = 4437482),
                    (c.INTERACTION_COLOR = 502775),
                    (c.EMISSIVE_COLOR = 2236962),
                    (c.HIGHLIGHT_EMISSIVE_COLOR = 10066329),
                    (c.OUTLINE_COLOR = 10066329),
                    (c.DEFAULT_BACK = 1710618),
                    (c.HIGHLIGHT_BACK = 3223857),
                    (c.INACTIVE_COLOR = 1447977),
                    (c.CONTROLLER_ID_SLIDER = 3121622),
                    (c.CONTROLLER_ID_CHECKBOX = 8415111),
                    (c.CONTROLLER_ID_BUTTON = 15080799),
                    (c.CONTROLLER_ID_TEXT = 2020207),
                    (c.CONTROLLER_ID_DROPDOWN = 16773120),
                    (c.DROPDOWN_BG_COLOR = 16777215),
                    (c.DROPDOWN_FG_COLOR = 0),
                    (c.CHECKBOX_BG_COLOR = 16777215),
                    (c.BUTTON_COLOR = 15080799),
                    (c.BUTTON_HIGHLIGHT_COLOR = 16396659),
                    (c.SLIDER_BG = 4473924);
            },
            {},
        ],
        4: [
            function (a, b, c) {
                ...
                function g() {
                    ...
                    function b(a, b) {
                        var e = (0, i.default)(l, a, C, A, m.DROPDOWN_FG_COLOR, m.DROPDOWN_BG_COLOR, 0.866);
                        ...
                        return (
                            ...
                            K.push(e),
                            b
                                ? f.events.on("onPressed", function (b) {
                                      M.setString(a);
                                      var d = !1;
                    ...
                    var j = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        B = { open: !1, listen: !1 },
                        C = 0.5 * w - o.PANEL_MARGIN,
                        D = y - o.PANEL_MARGIN,
                        E = A,
                        F = y - 1.2 * o.PANEL_MARGIN,
                        G = o.PANEL_MARGIN * -0.4,
                        H = new THREE.Group(),
                    ...
                    var J = [],
                        ...
                        L = a(),
                        M = b(L, !1);
                    (M.position.x = 0.5 * o.PANEL_MARGIN + 0.5 * w), (M.position.z = A);
                    var N = q.downArrow();
                    N.position.set(C - 0.04, 0, 1.01 * A), M.add(N), Array.isArray(u) ? M.add.apply(M, f(u.map(g))) : M.add.apply(M, f(Object.keys(u).map(g))), c();
                    var O = l.create(r);
                    (O.position.x = o.PANEL_LABEL_TEXT_MARGIN), (O.position.z = A), (O.position.y = -0.03);
                    var P = o.createControllerIDBox(y, m.CONTROLLER_ID_DROPDOWN);
                    P.position.z = A;
                    var Q = o.createPanel(C + o.BORDER_THICKNESS, D + 0.5 * o.BORDER_THICKNESS, E, !0);
                    Q.material.color.setHex(2063079), (Q.position.x = 0.5 * -o.BORDER_THICKNESS + 0.5 * w), (Q.position.z = 0.5 * A), I.add(O, P, M, Q), h();
                    var R = void 0;
                    H.onChange = function (a) {
                        return (R = a), H;
                    };
                    var S = t.create({ group: H, panel: I });
                    return (
                        (H.listen = function () {
                            return (B.listen = !0), H;
                        }),
                        (H.updateControl = function (b) {
                            B.listen && M.setString(a()),
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.default = g);
                var h = a("./textlabel"),
                    i = e(h),
                    j = a("./interaction"),
                    k = e(j),
        ...
        5: [
            function (a, b, c) {
                ...
                function f() {
                    ...
                    function b() {
                        ...
                        if (
                            ...
                            v.children.forEach(function (f) {
                                ...
                                (d -= h), (e = g), (c += g), (f.position.x = 0.026);
                            });
                        }
                    ...
                    var d = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        p = m.FOLDER_WIDTH,
                        q = m.PANEL_DEPTH,
                        s = { collapsed: !1, previousParent: void 0 },
                        u = new THREE.Group(),
                        v = new THREE.Group();
                    u.add(v),
                        (u.performLayout = b),
                        (u.isCollapsed = function () {
                            return s.collapsed;
                        });
                    ...
                    a(x);
                    var y = e.create(f);
                    (y.position.x = 1.5 * m.PANEL_LABEL_TEXT_MARGIN), (y.position.y = -0.03), (y.position.z = q), x.add(y);
                    var z = m.createDownArrow();
                    k.colorizeGeometry(z.geometry, 16777215), z.position.set(0.05, 0, 1.01 * q), x.add(z);
                    var A = m.createPanel(p, m.FOLDER_GRAB_HEIGHT, q, !0);
                    (A.position.y = 0.86 * m.FOLDER_HEIGHT), (A.name = "grabber"), a(A);
                    var B = o.grabBar();
                    B.position.set(0.5 * p, 0, 1.001 * q),
                        A.add(B),
                        (u.isFolder = !0),
                        (u.hideGrabber = function () {
                            A.visible = !1;
                        }),
                        (u.add = function () {
                    ...
                    C.events.on("onPressed", function (a) {
                        ...
                        (u.folder = u);
                    var D = r.create({ group: u, panel: A }),
                        E = t.create({ group: u, panel: x });
                    return (
                        (u.updateControl = function (a) {
            ...
            { "./colors": 3, "./grab": 7, "./graphic": 8, "./interaction": 10, "./layout": 11, "./palette": 12, "./sharedmaterials": 14, "./textlabel": 16 },
        ],
        6: [
            function (a, b, c) {
                "use strict";
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.image = d), (c.fnt = e);
            },
            {},
        ],
        7: [
            function (a, b, c) {
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.create = e);
                var f = a("./interaction"),
                    g = d(f);
            },
            { "./interaction": 10 },
        ...
        8: [
            function (a, b, c) {
                ...
                (c.grabBar = (function () {
                    ...
                    var c = new THREE.MeshBasicMaterial({ side: THREE.DoubleSide, transparent: !0, map: b });
                    return (
                        (c.alphaTest = 0.5),
                        function () {
                    ...
                    (c.downArrow = (function () {
                        ...
                        return (
                            ...
                            function () {
                                ...
                                return d.translate(-0.005, -0.004, 0), new THREE.Mesh(d, c);
                            }
                        );
                    })()),
                    (c.checkmark = (function () {
                        ...
                        return (
                            ...
                            function () {
                                var b = 0.4,
                                    d = new THREE.PlaneGeometry((a.width / 1e3) * b, (a.height / 1e3) * b, 1, 1);
                                return d.translate(0.025, 0, 0), new THREE.Mesh(d, c);
                            }
                        );
                    })());
            },
                ...
                var n =
                    ...
                    C = (function () {
                        function a(a) {
                            ...
                            for (var b = a.folder; b.folder !== b; ) if (((b = b.folder), b.isCollapsed() || !b.visible)) return !1;
                            return !0;
                        }
                        function b() {
                            return P.filter(a);
                        ...
                        function n() {
                            return new THREE.Mesh(new THREE.SphereGeometry(0.006, 4, 4), U);
                        }
                        function o() {
                            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new THREE.Group(),
                                b = {
                                    ...
                                    interaction: { grip: void 0, press: void 0, hover: void 0 },
                                };
                        ...
                        function q() {
                            ...
                            return (
                                (b.mouse = a),
                                (b.mouseIntersection = new THREE.Vector3()),
                                (b.mouseOffset = new THREE.Vector3()),
                                (b.mousePlane = new THREE.Plane()),
                                (b.intersections = []),
                                (b.mouseCamera = void 0),
                        ...
                        function s(a) {
                            var b = o(a);
                            return (
                                (b.laser.pressed = function (a) {
                                    a && b.intersections.length > 0 ? (b.pressed = !0) : (b.pressed = !1);
                                }),
                                (b.laser.gripped = function (a) {
                                    b.gripped = a;
                                }),
                                (b.laser.cursor = b.cursor),
                                THREE.ViveController && a instanceof THREE.ViveController && l(b, a, b.laser.pressed, b.laser.gripped),
                                O.push(b),
                                b.laser
                            );
                        }
                        function u(a, b) {
                            var c = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
                                ...
                                e = (0, r.default)({ textCreator: N, propertyName: b, object: a, min: c, max: d, initialValue: a[b] });
                            return P.push(e), Q.push.apply(Q, f(e.hitscan)), e;
                        }
                        function w(a, b) {
                            var c = (0, t.default)({ textCreator: N, propertyName: b, object: a, initialValue: a[b] });
                            return P.push(c), Q.push.apply(Q, f(c.hitscan)), c;
                        }
                        function y(a, b) {
                            var c = (0, v.default)({ textCreator: N, propertyName: b, object: a });
                            return P.push(c), Q.push.apply(Q, f(c.hitscan)), c;
                        }
                        function A(a, b, c) {
                            var d = (0, z.default)({ textCreator: N, propertyName: b, object: a, options: c });
                            return P.push(d), Q.push.apply(Q, f(d.hitscan)), d;
                        }
                        function C(a, b, c, d) {
                            if (void 0 !== a)
                                return void 0 === a[b] ? (console.warn("no property named", b, "on object", a), new THREE.Group()) : j(c) || k(c) ? A(a, b, c) : g(a[b]) ? u(a, b, c, d) : h(a[b]) ? w(a, b) : i(a[b]) ? y(a, b) : void 0;
                        }
                        function D() {
                        ...
                        function G(a) {
                            var b = { button: void 0 !== a ? a : function () {} };
                            return y(b, "button");
                        }
                        function H(a) {
                            var b = (0, x.default)({ textCreator: N, name: a, guiAdd: C, addSlider: D, addDropdown: E, addCheckbox: F, addButton: G });
                            return P.push(b), b.hitscan && Q.push.apply(Q, f(b.hitscan)), b;
                        }
                        function I() {
                            requestAnimationFrame(I);
                            var a = c();
                            R && (V.intersections = M(a, V)),
                                O.forEach(function () {
                                    var b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                        c = (b.box, b.object),
                                        d = b.raycast,
                                        ...
                                        g = arguments[1];
                                    c.updateMatrixWorld(),
                                        W.set(0, 0, 0).setFromMatrixPosition(c.matrixWorld),
                                        Y.identity().extractRotation(c.matrixWorld),
                                        X.set(0, 0, -1).applyMatrix4(Y).normalize(),
                                        d.set(W, X),
                                        e.geometry.vertices[0].copy(W);
                        ...
                        var N = B.creator(),
                            ...
                            R = !1,
                            S = void 0,
                            T = new THREE.LineBasicMaterial({ color: 5614335, transparent: !0, blending: THREE.AdditiveBlending }),
                            U = new THREE.MeshBasicMaterial({ color: 4473924, transparent: !0, blending: THREE.AdditiveBlending }),
                            V = q(),
                            W = new THREE.Vector3(),
                            X = new THREE.Vector3(0, 0, -1),
                            Y = new THREE.Matrix4();
                        return I(), { create: H, addInputObject: s, enableMouse: d, disableMouse: e };
                    })();
                window && (void 0 === window.dat && (window.dat = {}), (window.dat.GUIVR = C)), b && (b.exports = { dat: C }), "function" == typeof define && define.amd && define([], C);
            },
                        ...
                        (h = !1),
                            ...
                            b.forEach(function (b) {
                                ...
                                var e = c(b),
                                    ...
                                    j = a === g;
                                (h = h || j),
                                    d({ input: b, hover: j, hitObject: g, hitPoint: i, buttonName: "pressed", interactionName: "press", downName: "onPressed", holdName: "pressing", upName: "onReleased" }),
                                    d({ input: b, hover: j, hitObject: g, hitPoint: i, buttonName: "gripped", interactionName: "grip", downName: "onGripped", holdName: "gripping", upName: "onReleaseGrip" }),
                                    f.emit("tick", { input: b, hitObject: g, inputObject: b.object });
                            });
                    }
                    function c(a) {
                        return a.intersections.length <= 0 ? { hitPoint: k.setFromMatrixPosition(a.cursor.matrixWorld).clone(), hitObject: void 0 } : { hitPoint: a.intersections[0].point, hitObject: a.intersections[0].object };
                    }
                    function d() {
                        var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            b = a.input,
                        ...
                        if (b[g] !== !0 || void 0 !== d) {
                            if (c && b[g] === !0 && void 0 === b.interaction[h]) {
                                var o = { input: b, hitObject: d, point: e, inputObject: b.object, locked: !1 };
                                f.emit(k, o), o.locked && ((b.interaction[h] = m), (b.interaction.hover = m)), (i = !0), (j = !0);
                            }
                            if (b[g] && b.interaction[h] === m) {
                                var p = { input: b, hitObject: d, point: e, inputObject: b.object, locked: !1 };
                                f.emit(l, p), (i = !0), b.events.emit("onControllerHeld");
                            }
                            b[g] === !1 && b.interaction[h] === m && ((b.interaction[h] = void 0), (b.interaction.hover = void 0), f.emit(n, { input: b, hitObject: d, point: e, inputObject: b.object }));
                        }
                    }
                    function e() {
        ...
        11: [
            function (a, b, c) {
                ...
                function f(a, b, c, d) {
                    var e = d ? new THREE.MeshBasicMaterial({ color: 16777215 }) : j.PANEL,
                        f = new THREE.Mesh(new THREE.BoxGeometry(a, b, c), e);
                    return f.geometry.translate(0.5 * a, 0, 0), d ? e.color.setHex(l.DEFAULT_BACK) : l.colorizeGeometry(f.geometry, l.DEFAULT_BACK), f;
                }
                function g(a, b) {
                    var c = new THREE.Mesh(new THREE.BoxGeometry(m, a, n), j.PANEL);
                    return c.geometry.translate(0.5 * m, 0, 0), l.colorizeGeometry(c.geometry, b), c;
                }
                function h() {
                    var a = 0.0096,
                        b = 0.016,
                    ...
                    return d.translate(0, 0.5 * -b, 0), new THREE.Mesh(d, j.PANEL);
                }
                Object.defineProperty(c, "__esModule", { value: !0 }),
                ...
                var i = a("./sharedmaterials"),
                    ...
                    m =
                        ...
                        (c.PANEL_HEIGHT = 0.08),
                        (c.PANEL_DEPTH = 0.01),
                        (c.PANEL_SPACING = 0.001),
                        (c.PANEL_MARGIN = 0.015),
                        (c.PANEL_LABEL_TEXT_MARGIN = 0.06),
                        (c.PANEL_VALUE_TEXT_MARGIN = 0.02),
                        (c.CONTROLLER_ID_WIDTH = 0.02)),
                    n = (c.CONTROLLER_ID_DEPTH = 0.001);
                (c.BUTTON_DEPTH = 0.01), (c.FOLDER_WIDTH = 1.026), (c.FOLDER_HEIGHT = 0.08), (c.FOLDER_GRAB_HEIGHT = 0.0512), (c.BORDER_THICKNESS = 0.01), (c.CHECKBOX_SIZE = 0.05);
            },
            ...
            function (a, b, c) {
                ...
                function e() {
                    ...
                    var h = void 0,
                        ...
                        j = new THREE.Euler(),
                        k = new THREE.Group();
                    return k.scale.set(0.3, 0.3, 0.3), k.position.set(-0.015, 0.015, 0), f;
                }
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.create = e);
                var f = a("./interaction"),
                    g = d(f);
            ...
            function (a, b, c) {
                ...
                function f(a) {
                    ...
                    return (
                        ...
                        (b.generateMipmaps = !1),
                        new THREE.RawShaderMaterial((0, i.default)({ side: THREE.DoubleSide, transparent: !0, color: a, map: b }))
                    );
                }
                function g() {
                    function a(a, b) {
                        var c = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 16777215,
                            ...
                            g = (0, k.default)({ text: a, align: "left", width: 1e4, flipY: !0, font: b }),
                            h = g.layout,
                            i = d[c];
                        void 0 === i && (i = d[c] = f(c));
                        ...
                        var l = e * p;
                        return j.scale.multiplyScalar(l), (j.position.y = 0.5 * h.height * l), j;
                    }
                    function b(b) {
                        ...
                        return (
                            i.add(j),
                            (i.layout = j.geometry.layout),
                            (i.updateLabel = function (a) {
                                j.geometry.update(a);
                            }),
                            i
                        );
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.createMaterial = f), (c.creator = g);
        ...
        14: [
            function (a, b, c) {
                ...
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.FOLDER = c.LOCATOR = c.PANEL = void 0);
                var e = a("./colors");
                d(e), (c.PANEL = new THREE.MeshBasicMaterial({ color: 16777215, vertexColors: THREE.VertexColors })), (c.LOCATOR = new THREE.MeshBasicMaterial()), (c.FOLDER = new THREE.MeshBasicMaterial({ color: 0 }));
            },
            { "./colors": 3 },
        ],
        15: [
            function (a, b, c) {
                ...
                function f() {
                    ...
                    function r() {
                        ...
                        if (W.visible !== !1) {
                            ...
                            var h = new THREE.Vector3().setFromMatrixPosition(aa.matrixWorld),
                                ...
                                j = V.value;
                            e(g(f, { a: h, b: i })), a(V.value), c(), d(V.value), j !== V.value && V.onChangedCB && V.onChangedCB(V.value);
                        }
                    }
                    function t() {
                        V.pressing = !1;
                    ...
                    var v = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        S = 0.5 * N - w.PANEL_MARGIN,
                        T = P - w.PANEL_MARGIN,
                        U = R,
                        V = { alpha: 1, value: F, step: L, useStep: !0, precision: 1, listen: !1, min: H, max: J, onChangedCB: void 0, onFinishedChange: void 0, pressing: !1 };
                    (V.step = k(V.value)), (V.precision = o(V.step)), (V.alpha = m(V.value, V.min, V.max));
                    var W = new THREE.Group(),
                        X = new THREE.BoxGeometry(S, T, U);
                    X.translate(0.5 * S, 0, 0);
                    var Y = new THREE.MeshBasicMaterial();
                    Y.visible = !1;
                    var Z = new THREE.Mesh(X.clone(), Y);
                    (Z.position.z = R), (Z.position.x = 0.5 * N), (Z.name = "hitscanVolume");
                    var $ = new THREE.Mesh(X.clone(), y.PANEL);
                    u.colorizeGeometry($.geometry, u.SLIDER_BG), ($.position.z = 0.5 * R), ($.position.x = S + w.PANEL_MARGIN);
                    var _ = new THREE.MeshBasicMaterial({ color: u.DEFAULT_COLOR }),
                        aa = new THREE.Mesh(X.clone(), _);
                    (aa.position.z = 0.5 * R), Z.add(aa);
                    var ba = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.05, 0.05, 1, 1, 1), y.LOCATOR);
                    (ba.position.x = S), Z.add(ba), (ba.visible = !1);
                    var ca = x.create(V.value.toString());
                    (ca.position.x = w.PANEL_VALUE_TEXT_MARGIN + 0.5 * N), (ca.position.z = 2.5 * R), (ca.position.y = -0.0325);
                    var da = x.create(D);
                    (da.position.x = w.PANEL_LABEL_TEXT_MARGIN), (da.position.z = R), (da.position.y = -0.03);
                    ...
                    var ha = A.create({ group: W, panel: fa }),
                        ia = C.create({ group: W, panel: fa });
                    return (
                        (W.updateControl = function (d) {
            ...
            { "./colors": 3, "./grab": 7, "./interaction": 10, "./layout": 11, "./palette": 12, "./sharedmaterials": 14, "./textlabel": 16 },
        ],
        16: [
            function (a, b, c) {
                "use strict";
                ...
                function e(a, b) {
                    var c = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0.4,
                        d = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0.029,
                        ...
                        k = new THREE.Group();
                    j.add(k);
                    var l = a.create(b, { color: e, scale: h });
                    k.add(l),
                        (j.setString = function (a) {
                    ...
                    p.applyMatrix(new THREE.Matrix4().makeTranslation(0.5 * n - m, 0, 0));
                    var q = new THREE.Mesh(p, i.PANEL);
                    return g.colorizeGeometry(q.geometry, f), (q.position.y = 0.03), k.add(q), (k.position.y = 0.5 * -o), (j.back = q), j;
                }
                Object.defineProperty(c, "__esModule", { value: !0 }), (c.default = e);
                var f = a("./colors"),
                    g = d(f),
                    ...
                    (function () {
                        ...
                        function b(a, b, c, d, e, f) {
                            ...
                            if (j in d) g = d[j];
                                ...
                                var k = c[h],
                                    l = c[i];
                                (g = { a: k, b: l, newEdge: null, faces: [] }), (d[j] = g);
                            }
                            g.faces.push(e), f[a].edges.push(g), f[b].edges.push(g);
                        }
                        function c(a, c, d, e) {
                            var f, g, h;
                            for (f = 0, g = a.length; f < g; f++) d[f] = { edges: [] };
                        ...
                        THREE.SubdivisionModifier.prototype.smooth = function (b) {
                            ...
                            for (o in t) {
                                for (
                                    A = t[o],
                                        ...
                                        E = 1 / 8,
                                        F = A.faces.length,
                                        2 != F && ((D = 0.5), (E = 0), 1 != F && g && console.warn("Subdivision Modifier: Number of connected faces != 2, is: ", F, A)),
                                        B.addVectors(A.a, A.b).multiplyScalar(D),
                                        w.set(0, 0, 0),
                                        q = 0;
                                    q < F;
                                    q++
                            ...
                            for (v = [], o = 0, p = i.length; o < p; o++) {
                                for (
                                    L = i[o],
                                        K = s[o].edges,
                                        n = K.length,
                                        3 == n ? (G = 3 / 16) : n > 3 && (G = 3 / (8 * n)),
                                        H = 1 - n * G,
                                        I = G,
                                        n <= 2 && (2 == n ? (g && console.warn("2 connecting edges", K), (H = 0.75), (I = 1 / 8)) : 1 == n ? g && console.warn("only 1 connecting edge") : 0 == n && g && console.warn("0 connecting edges")),
                                        M = L.clone().multiplyScalar(H),
                                        w.set(0, 0, 0),
                                        q = 0;
                                    q < n;
                                    q++
                                )
                                    (J = K[q]), (z = J.a !== L ? J.a : J.b), w.add(z);
                            ...
                            for (o = 0, p = j.length; o < p; o++)
                                (C = j[o]),
                                    (N = a(C.a, C.b, t).newEdge + Q),
                                    (O = a(C.b, C.c, t).newEdge + Q),
                                    (P = a(C.c, C.a, t).newEdge + Q),
                                    d(m, N, O, P),
                                    d(m, C.a, N, P),
                                    d(m, C.b, O, N),
                                    d(m, C.c, P, O),
                                    y &&
                                        ...
                                        (T = R[1]),
                                        (U = R[2]),
                                        V.set(e(S.x, T.x), e(S.y, T.y)),
                                        W.set(e(T.x, U.x), e(T.y, U.y)),
                                        X.set(e(S.x, U.x), e(S.y, U.y)),
                                        f(x, V, W, X),
                                        f(x, S, V, X),
                                        f(x, T, W, V),
                                        f(x, U, X, W));
            ...
            function (a, b, c) {
                function d(a, b, c) {
                    ...
                    if (((c = 0 | +(c || 0)), Array.isArray(a) && Array.isArray(a[0]))) {
                        ...
                        for (var h = 0, i = c; h < a.length; h++) for (var j = 0; j < d; j++) b[i++] = a[h][j];
        ...
        26: [
            function (a, b, c) {
                ...
                function e(a) {
                    Object.defineProperty(d.prototype, a, { get: f(a), configurable: !0 });
                }
                function f(a) {
                ...
                (b.exports = function (a) {
                    ...
                    (d.prototype.update = function (a) {
                        if (((a = n({ measure: this._measure }, a)), (this._opt = a), (this._opt.tabSize = p(this._opt.tabSize, 4)), !a.font)) throw new Error("must provide a valid bitmap font");
                        var b = this.glyphs,
                            c = a.text || "",
                            d = a.font;
                        ...
                        e.forEach(function (a, e) {
                            for (var f, h = a.start, j = a.end, l = a.width, m = h; m < j; m++) {
                                ...
                                if (p) {
                                    f && (i += k(d, f.id, p.id));
                                    var r = i;
                                    v === w ? (r += (g - l) / 2) : v === x && (r += g - l), b.push({ position: [r, o], data: p, index: m, line: e }), (i += p.xadvance + t), (f = p);
                                }
                            }
                            (o += q), (i = 0);
                        }),
                    ...
                    (d.prototype._setupSpaceGlyphs = function (a) {
                        if (((this._fallbackSpaceGlyph = null), (this._fallbackTabGlyph = null), a.chars && 0 !== a.chars.length)) {
                            ...
                            (this._fallbackSpaceGlyph = b), (this._fallbackTabGlyph = n(b, { x: 0, y: 0, xadvance: c, id: t, xoffset: 0, yoffset: 0, width: 0, height: 0 }));
                        }
                    }),
                    ...
                    (d.prototype.computeMetrics = function (a, b, c, d) {
                        var e,
                            f,
                            g = this._opt.letterSpacing || 0,
                            h = this._opt.font,
                            i = 0,
                            j = 0,
                            l = 0;
                        if (!h.chars || 0 === h.chars.length) return { start: b, end: b, width: 0 };
                        ...
                        return f && (j += f.xoffset), { start: b, end: b + l, width: j };
                    }),
            ...
            function (a, b, c) {
                function d(a, b) {
                    ...
                    for (var f = [], g = 0; g < a.length; g++) {
                        var h = a[g];
                        0 === g ? f.push({ key: h[0], data: "" }) : g === a.length - 1 ? (f[f.length - 1].data = e(h[0])) : ((f[f.length - 1].data = e(h[0])), f.push({ key: h[1], data: "" }));
                    }
                    var i = { key: d, data: {} };
                    return (
        ...
        29: [
            function (a, b, c) {
                var d = a("dtype"),
                    ...
                    h = [2, 1, 3];
                b.exports = function (a, b) {
                    (a && (e(a) || f(a))) || ((b = a || {}), (a = null)), (b = "number" == typeof b ? { count: b } : b || {});
                    for (
                        var c = "string" == typeof b.type ? b.type : "uint16",
                            i = "number" == typeof b.count ? b.count : 1,
                            j = b.start || 0,
                            k = b.clockwise !== !1 ? g : h,
                            l = k[0],
                            m = k[1],
        ...
        30: [
            function (a, b, c) {
                function d(a) {
                    l.call(this), "string" == typeof a && (a = { text: a }), (this._opt = i({}, a)), a && this.update(a);
                }
                ...
                (b.exports = function (a) {
                    ...
                    f(d, l),
                    (d.prototype.update = function (a) {
                        if (("string" == typeof a && (a = { text: a }), (a = i({}, this._opt, a)), !a.font)) throw new TypeError("must specify a { font } in options");
                        this.layout = e(a);
                        var b = a.flipY !== !1,
                            c = a.font,
                            d = c.common.scaleW,
                        ...
                        var l = j.positions(k),
                            m = j.uvs(k, d, f, b),
                            n = g({ clockwise: !0, type: "uint16", count: k.length });
                    ...
                    (d.prototype.computeBoundingSphere = function () {
                        ...
                        return !a || !b || a.length < 2
                            ? ((this.boundingSphere.radius = 0), void this.boundingSphere.center.set(0, 0, 0))
                            : (k.computeSphere(a, this.boundingSphere),
                              void (isNaN(this.boundingSphere.radius) && console.error('THREE.BufferGeometry.computeBoundingSphere(): Computed radius is NaN. The "position" attribute is likely to have NaN values.')));
                    }),
            ...
            { "./lib/utils": 31, "./lib/vertices": 32, inherits: 24, "layout-bmfont-text": 26, "object-assign": 27, "quad-indices": 29, "three-buffer-vertex-data": 34 },
        ],
        31: [
            function (a, b, c) {
                function d(a) {
            ...
            function (a, b, c) {
                ...
                b.exports = function (a) {
                    ...
                    return (
                        ...
                        d(
                            {
                                uniforms: { opacity: { type: "f", value: b }, map: { type: "t", value: g || new THREE.Texture() }, color: { type: "c", value: new THREE.Color(f) } },
                                vertexShader: [
                                    "attribute vec2 uv;",
                                ...
                                fragmentShader: [
                                    ...
                                    0 === c ? "" : "  if (gl_FragColor.a < " + c + ") discard;",
                                    "}",
                                ].join("\n"),
                            },
                            a
        ...
        34: [
            function (a, b, c) {
                ...
                function e(a, b, c, d, e) {
                    if (("number" != typeof d && (d = 3), "string" != typeof e && (e = "float32"), Array.isArray(c) && Array.isArray(c[0]) && c[0].length !== d))
                        throw new Error("Nested vertex array has unexpected size; expected " + d + " but found " + c[0].length);
                ...
                function f(a, b, c, d) {
                    if (((b = b || []), !a || g(a, b, c))) {
                        b = h(b, d);
                        var e = a && "function" != typeof a.setAttribute;
                        return (
                            (a && !e) ||
                                (e &&
                                    !i &&
                                ...
                                (a = new THREE.BufferAttribute(b, c))),
                            (a.itemSize = c),
                            (a.needsUpdate = !0),
                            "function" == typeof a.setAttribute && a.setAttribute(b),
                            a
                        );
                    }
                ...
                function g(a, b, c, f, g, h) {
                    ...
                    for ("nowrap" === h && (k = Number.MAX_VALUE); c < f && c < b.length; ) {
                        ...
                        if (n < l) {
                            ...
                            else for (o = n; n > c && e(b.charAt(n - j.length)); ) n--;
                        }
                        if (n >= c) {
                            var p = a(b, c, n, k);
                            i.push(p);
